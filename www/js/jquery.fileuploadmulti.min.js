...
(function(b) {
    ...
    b.fn.uploadFile = function(t) {
        var r = b.extend({
            ...
            dragDropStr: "<span style='color:#C42522'>(ECG, X-RAY, BLOOD TEST-TROPNIN, ECHO)</span>",
            abortStr: "Abort",
            cancelStr: "Cancel",
            deletelStr: "Delete",
            doneStr: "Done",
        ...
        function l(H, B, u) {
            for (var C = 0; C < u.length; C++) {
                if (!c(B, H, u[C].name)) {
                    if (H.showError) {
                        b("<div id='hidethirured' style='color:red;'><b>" + u[C].name + "</b> " + H.extErrorStr + H.allowedTypes + "</div>").appendTo(B.errorLog)
                    }
                    continue
                }
                ...
                error: function(C, s, B) {
                    ...
                    if (C.statusText == "abort") {
                        ...
                        if (y.showStatusAfterError) {
                            u.progressDiv.hide();
                            u.statusbar.append("<span style='color:red;'>ERROR:Check Your Network Connection " + B + "</span>")
                        } else {
                            u.statusbar.hide();
                            u.statusbar.remove()
                        }
